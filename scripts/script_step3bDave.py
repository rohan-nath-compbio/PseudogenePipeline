...
with open(sys.argv[1]) as inp:
    for inl in inp:
        ...
        #print L
        int2 = L[0]
        ic2 = ast.literal_eval(L[1]) # intergenic seq coord
        pc2 = ast.literal_eval(L[2]) # protein coord
        ev2 = ast.literal_eval(L[3]) # evalues
        gl2 = ast.literal_eval(L[5]) # gene names
...
with open("%s_I%i.PS1" % (sys.argv[1],lenT),"w") as oup:
    c = 0
