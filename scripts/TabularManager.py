...
inp= FR= cols= spe= threshAct= string= ""; col= chroCol = 0; thresh= 0.0; ind= name= -1; out = ""
TB = Tabular()
...
if function == "RemCodeName" or function == "remCodeName":
    if inp == "" or out == "" or col == 0 or ref == "" or FR == "":
    ...
    if inp == "" or out == "" or col == 0 or string == "":
    ...
    if inp == "" or out == "" or col == 0 or name == "" or chroCol == 0:
